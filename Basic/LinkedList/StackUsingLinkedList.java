public class StackUsingLinkedList{
	...
	public static int pop(){
		if(true) //isEmpty()) -instead
			 throw new  UnsupportedOperationException("stack is already empty!! you cannot pop");
		int item =first.data;
		first=first.next;
		return item;
	}
...
//dummy node
    ...
    public static Node buildListDummy(){
        Node dummy = new Node();
        Node tail = dummy;
        int n = 10;
        for(int i=1;i<n;i++){
...
//count number of times an int occurs in a list
    ...
    public static Node getNth(Node current, int n){
        int count = 1;
        while(current!=null){
            if(count==n)
                return current;
   ...
   // Problem 4:
    ...
    public static void insertNth(Node list,int data, int n){
        ...
        if(i!=n-1)
            throw new IllegalArgumentException("send n value within the  size of the linked list");
    }
...
//better solution
    ...
    public static void sortedInsert2(Node head, Node newNode){
...
//easy solution - dummy node
    ...
    public static Node sortedInsert1(Node head, Node newNode){
        Node dummy = new Node();
...
//problem 9: FrontBackSplit {2,3,5,7,11} o/p: {2,3,5} {7,11}
    ...
    public static void frontBackSplit(Node a, Node b, Node c){
        if(a==null)
            throw new IllegalArgumentException("List is empty, you cannot split");
        Node slow = a;
...
//dummy node implementation would be simpler
    ...
    public static void alternatingSplit1(Node head){
...
//problem 15: mergeSort
    ...
    public static void sort(Node head){
        ...
        if(head==null)
             throw new IllegalArgumentException("List is empty, cannot sort");
        Node a=head;
        Node slow = a;
        Node fast = a; //this doesnt work
        while(fast.next!=null){
